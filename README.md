...
## Quantify Pain Points - Examples of Usage Scenarios
...
# 0 Python Environment Setup(Non-Anaconda)


## 0.1 [Download Python](https://www.python.org/downloads/)
...
## 0.3 Configure the environment variables

### 0.3.1 Environment variable configuration method1
...
### 0.3.2 Environment variable configuration method2
...
## 0.4 Frequent used Python Environment variables
![image](resources/images/pic4.png?raw=true)

## 0.5 **validate PYTHON installation result**
